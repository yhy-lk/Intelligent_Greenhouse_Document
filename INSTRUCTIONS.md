...
| 第四章 | STM32 控制层软件设计 | 25-30% | 3,500-5,500 | 驱动开发、控制算法、调度器、通信协议 |
| 第五章 | ESP32 交互层软件设计 | 20-25% | 3,000-4,500 | GUI 设计、网络通信、API 集成、语音交互 |
| 第六章 | 总结与展望 | 5-10% | 800-1,500 | 工作总结、创新点、不足与展望 |
