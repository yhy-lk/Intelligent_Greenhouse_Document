...
$$T = -45 + 175 \times \frac{S_T}{65535} \quad (°C) \tag{4.1}$$

$$RH = 100 \times \frac{S_{RH}}{65535} \quad (\%RH) \tag{4.2}$$
...
$$M = \frac{4000 - D_{ADC}}{4000 - 1000} \times 100\% \tag{4.3}$$
...
$$u(k) = K_p \cdot e(k) + K_i \cdot \sum_{j=0}^{k} e(j) \cdot \Delta t + K_d \cdot \frac{e(k) - e(k-1)}{\Delta t} \tag{4.4}$$
